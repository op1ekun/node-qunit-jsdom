...
QUnit.config.testSuiteName = options.name;
...
(function($) {
    /*
     * always provide qunit-fixture for tests that require to refresh HTML
     * qunit-fixture can't be used because it is always cleared after testcase
     * @see t/js/component/tooltips/cbon.js
     */
    $('body')
        .append('<div id="fixture"></div>');

    // append template (optional)
    // use only for STATIC HTML!        
...
// now, finaly fire the onload event for window
(function($) {
    var e = $.Event('load');
    $(window).trigger(e);
}(jQuery));