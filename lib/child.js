var jQuery          = require('jquery'),
    ...
    // jsdom added to support DOM + jQuery + XHR
    jsdom           = require('jsdom'),
...
var doc     = jsdom.jsdom('<!DOCTYPE html><html><head><script src="public/js/lib/librarian.js" id="librarian"></script><title>Javascript Continuous Integration</title></head><body></body></html>');
var window  = doc.createWindow();
window.localStorage = localStorage;
window.document.location.protocol   = "http:";
window.document.location.host       = "lp5031.sempro.hurra";
